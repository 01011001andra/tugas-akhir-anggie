export default function SectionTentang() {
  return (
    <section className="bg-neutral-100 w-full px-6 lg:px-0 mb-20">
      <div
        className="container mx-auto flex flex-col items-center py-10 lg:py-16 gap-6 lg:gap-10"
        data-aos="fade-up"
      >
        {/* Judul */}
        ...
        <p className="text-base sm:text-lg lg:text-xl text-center text-neutral-800 max-w-4xl">
          Vertigrow merupakan platform pertama yang berfokus pada edukasi
          pertanian modern, khususnya teknik vertikultur. Tujuan kami adalah
          memberdayakan anak muda untuk mencapai keberlangsungan sektor
