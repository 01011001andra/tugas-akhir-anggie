...
export default function SectionHero() {
  return (
    <section className="container flex flex-col-reverse lg:flex-row items-center py-20 gap-10 lg:min-h-[90vh] px-6 lg:px-0">
      {/* Kalimat Hero */}
      <div className="flex flex-col gap-6 lg:text-left" data-aos="fade-up">
        ...
        <p className="text-lg sm:text-xl lg:text-2xl text-neutral-800">
          Ayo bergabung bersama kami dalam mewujudkan masa depan pertanian
          Indonesia yang lebih produktif dan berkelanjutan.
        </p>
