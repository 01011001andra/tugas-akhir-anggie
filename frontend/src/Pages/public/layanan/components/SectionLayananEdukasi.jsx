    ...
    <section className="container mx-auto flex flex-col md:flex-row items-center justify-between py-20 gap-16 mt-36">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-8">
        ...
        <p className="text-lg text-neutral-700 md:text-left">
          ...
          voluptatem aperiam est dolorum voluptate quibusdam minus. Id deleniti
          alias minima omnis reprehenderit? At nihil, magnam, numquam maiores
          amet laboriosam, unde cupiditate praesentium eveniet fugiat beatae!
          Recusandae dolorem doloribus et, quibusdam ex provident eaque
          voluptates at possimus quos atque adipisci quaerat?
        </p>
