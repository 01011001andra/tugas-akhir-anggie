...
INSERT INTO "new_Transaction" ("createdAt", "id", "paymentMethod", "status", "totalPrice", "updatedAt", "userId") SELECT "createdAt", "id", "paymentMethod", "status", "totalPrice", "updatedAt", "userId" FROM "Transaction";
